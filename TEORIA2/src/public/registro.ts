...
const checkUser = document.getElementById('checkUser') as HTMLInputElement



document.getElementById('btnSaveData')?.addEventListener('click', async (e: any) => {

    e.preventDefault()

    const firstName = document.getElementById('firstName') as HTMLInputElement
    const lastName = document.getElementById('lastName') as HTMLInputElement
    const user_age = document.getElementById('user_age') as HTMLInputElement
    ...
    if (checkbox) checkUser.innerHTML = ''
